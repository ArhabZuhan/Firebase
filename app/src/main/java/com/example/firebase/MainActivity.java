...
import com.example.firebase.UserAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), EditorActivty.class));
        });
    }
    @Override
    ...
    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
        ...
        private void deleteData(String id){
            ...
            db.collection("users").document(id)
                    .delete()
                    .adanCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (!task.isSuccessful()) {
                                Toast.makeText(getApplicationContext(), "Data gagal di hapusl", Toast.LENGTH_SHORT).show();
                            }
                            progressDialog.dismiss();
                            getData();
                        }
